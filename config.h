...
static Key keys[] = {
	...
	{ 0,                            XK_VOLM,   spawn,          SHCMD("amixer set Master toggle") },
	{ 0,                            XK_VOLD,   spawn,          SHCMD("amixer set Master 5%-") },
	{ 0,                            XK_VOLU,   spawn,          SHCMD("amixer set Master 5%+") },
	{ MODKEY | ShiftMask,           XK_t,      spawn,          {.v = htopcmd } },
	{ MODKEY | ShiftMask,           XK_p,      spawn,          SHCMD("~/scripts/project_screen.sh") },
	{ MODKEY | ShiftMask,           XK_l,      spawn,          SHCMD("slock") },
	{ MODKEY | ShitMask,            XK_b,      togglebar,      {0} },
